            ...
            <Card glow="gold">
              ...
              <div className="space-y-3 mb-4">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-osrs-text">{selectedRelics.length} / {league.relicTiers.filter((t) => t.relics.length > 0).length}</span>
                </div>
                <div className="flex justify-between text-sm">
              ...
              <ProgressBar value={selectedRelics.length} max={league.relicTiers.filter((t) => t.relics.length > 0).length} label="Relics Selected" color="bg-osrs-gold" size="sm" />
            </Card>
