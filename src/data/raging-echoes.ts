  ...
  regions: [
    {
      id: "misthalin",
      name: "Misthalin",
      description: "Starting region containing Lumbridge, Varrock, and the Grand Exchange. Provides essential quest hubs, banks, and early-game training areas including the Stronghold of Security and Barbarian Village.",
      type: "starting",
      keyContent: ["Lumbridge", "Varrock", "Grand Exchange", "Stronghold of Security", "Barbarian Village", "Champion's Guild", "Edgeville"],
    },
    {
      id: "karamja",
      name: "Karamja",
      description: "Auto-unlocked alongside your first region choice. Home to the TzHaar city with Fight Caves and the Inferno, Brimhaven Dungeon with metal dragons, and the Brimhaven Agility Arena. Shilo Village provides gem rocks for early Crafting.",
      type: "auto-unlock",
      keyContent: ["Fight Caves (TzTok-Jad)", "Inferno (TzKal-Zuk)", "Brimhaven Dungeon", "Brimhaven Agility Arena", "Shilo Village", "Gem rocks", "Tai Bwo Wannai"],
    },
    {
      id: "asgarnia",
      name: "Asgarnia",
      description: "Packed with high-value PvM content. God Wars Dungeon houses Bandos, Saradomin, Zamorak, Armadyl, and Nex. Warriors' Guild provides defenders, Pest Control offers Void equipment, and Corporeal Beast is accessible for endgame drops. Motherload Mine and the Mining Guild serve as top mining training areas.",
      type: "choosable",
    ...
    },
    {
      ...
      description: "Offers strong bossing through Vorkath and the Dagannoth Kings, plus access to the Fremennik Slayer Dungeon for Kurasks and Turoths. Lunar Isle provides Lunar spellbook access. Duke Sucellus (DT2) is classified in this region for league purposes. Miscellania provides passive resource generation.",
      type: "choosable",
    ...
    },
    {
      id: "kandarin",
      name: "Kandarin",
      description: "A versatile region spanning Ardougne, Seers' Village, and Catherby. Zulrah provides best-in-class ranged and magic weapon drops. The Ranging Guild and Piscatoris Fishing Colony offer niche training, while the Gnome Stronghold gives access to tree runs and glider travel.",
      type: "choosable",
    ...
    },
    {
      ...
      description: "Home to Tombs of Amascut (Raids 3), the top-tier raid for high-level PvM. Kalphite Queen provides a dragon chain and head for Slayer helm recolor. Pyramid Plunder is the fastest Thieving training method. The Leviathan (DT2) is classified in this region for league purposes.",
      type: "choosable",
      keyContent: ["Tombs of Amascut (Raids 3)", "Kalphite Queen", "Pyramid Plunder", "Leviathan (DT2)", "Sophanem", "Pollnivneach", "Nardah"],
      echoBoss: "Echo Tempoross",
    },
    {
      id: "morytania",
      name: "Morytania",
      description: "Theatre of Blood (Raids 2) is the headline endgame content, with Barrows providing accessible mid-game gear. The Nightmare and Phosani's Nightmare drop best-in-slot items. Hallowed Sepulchre is the best Agility training in the game. The Slayer Tower offers convenient multi-level Slayer tasks.",
      type: "choosable",
    ...
    },
    {
      id: "tirannwn",
      name: "Tirannwn",
      description: "Prifddinas (the Elven City) is the crown jewel, offering high-level skilling, Zalcano for Mining-based bossing, and crystal equipment. The Gauntlet and Corrupted Gauntlet require no gear and drop the Blade of Saeldor and Crystal armour seeds. Araxxor provides the Noxious halberd.",
      type: "choosable",
    ...
    },
    {
      id: "wilderness",
      name: "Wilderness",
      description: "High-risk, high-reward area with exclusive Wilderness bosses in both regular and demi-boss variants. Revenant Caves offer valuable drops and the Chaos Temple provides a free-use gilded altar for Prayer training. King Black Dragon is accessible here. Safe in leagues (no PvP), but the content is tuned for endgame.",
      type: "choosable",
      keyContent: ["Callisto / Artio", "Venenatis / Spindel", "Vet'ion / Calvar'ion", "King Black Dragon", "Revenant Caves", "Chaos Temple (free altar)", "Mage Arena", "Scorpia"],
      echoBoss: "Echo King Black Dragon",
    },
    {
      id: "kourend",
      name: "Kourend & Kebos",
      description: "The most content-dense region. Chambers of Xeric (Raids 1) provides top-tier PvM, Alchemical Hydra drops the best ranged weapon component, and Wintertodt offers fast Firemaking training. The Catacombs of Kourend are packed with Slayer monsters. Guardians of the Rift and Tithe Farm round out the skilling content.",
      type: "choosable",
    ...
    },
    {
      id: "varlamore",
      name: "Varlamore",
      description: "The newest region in OSRS, featuring the Fortis Colosseum for endgame combat challenges and the Hunter Guild for advanced Hunter training. Colossal Wyrm Agility Course offers a unique Agility training method, and Mastering Mixology provides Herblore activities. Moons of Peril is accessible for mid-tier bossing.",
      type: "choosable",
      keyContent: ["Fortis Colosseum", "Moons of Peril", "Hunter Guild", "Colossal Wyrm Agility", "Mastering Mixology", "Amoxliatl", "Hueycoatl"],
    },
  ],
