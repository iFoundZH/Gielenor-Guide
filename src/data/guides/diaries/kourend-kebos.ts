      ...
      tasks: [
        {
          ...
          description: "{| class=\"wikitable lighttable qc-active diary-table\" style=width:750px; data-diary-name=\"Kourend & Kebos\" data-diary-tier=\"Easy\"\n! style=\"width:50%;\" | Task\n! style=\"width:50%;\" | Requirements",
          requirements: [
          ],
        },
        {
        ...
        {
          id: "diary-kourend-kebos-easy-14",
      ...
      tasks: [
        {
          ...
          description: "{| class=\"wikitable lighttable qc-active diary-table\" style=width:750px; data-diary-name=\"Kourend & Kebos\" data-diary-tier=\"Medium\"\n! style=\"width:50%;\" | Task\n! style=\"width:50%;\" | Requirements",
          requirements: [
          ],
        },
        {
        ...
        {
          id: "diary-kourend-kebos-medium-14",
      ...
      tasks: [
        {
          ...
          description: "{| class=\"wikitable lighttable qc-active diary-table\" style=width:750px; data-diary-name=\"Kourend & Kebos\" data-diary-tier=\"Hard\"\n! style=\"width:50%;\" | Task\n! style=\"width:50%;\" | Requirements",
          requirements: [
          ],
        },
        {
        ...
        {
          id: "diary-kourend-kebos-hard-12",
      ...
      tasks: [
        {
          ...
          description: "{| class=\"wikitable lighttable qc-active diary-table\" style=width:750px; data-diary-name=\"Kourend & Kebos\" data-diary-tier=\"Elite\"\n! style=\"width:50%;\" | Task\n! style=\"width:50%;\" | Requirements",
          requirements: [
          ],
        },
        {
        ...
        {
          id: "diary-kourend-kebos-elite-9",
