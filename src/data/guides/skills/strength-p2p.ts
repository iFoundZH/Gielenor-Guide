...
export const strengthP2pGuide: SkillTrainingGuide = {
  skill: "Strength" as SkillTrainingGuide["skill"],
  variant: "p2p",
  ...
  methods: [
    {
      ...
      xpPerHour: null,
      description:
        "Completing the Waterfall Quest at level 1 Attack and Strength will instantly bring the player to level 30 in both skills. This quest has no combat requirements, making it the fastest way to skip early melee training.",
      members: true,
    },
    {
      name: "Chickens",
      ...
      xpPerHour: null,
      description:
        "Kill chickens near Lumbridge for early combat experience. They have only 3 Hitpoints and deal no damage, making them safe for brand new accounts. Feathers and raw chicken can be collected for minor profit.",
      members: true,
    },
    {
      name: "Rock Crabs",
