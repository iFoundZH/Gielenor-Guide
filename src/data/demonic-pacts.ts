...
export const demonicPactsLeague: LeagueData = {
      ...
      relics: [
        {
          ...
          tier: 3,
          slot: 3,
          description: "banker's briefcase",
          effects: [
            "Grants the banker's briefcase",
      ...
      relics: [
        ...
        },
        {
          ...
          effects: [
            ...
            "Pickpocketing (Including clue scrolls)",
      ...
      relics: [
        {
          ...
          tier: 7,
          slot: 7,
          description: "Mining, Woodcutting, Fishing, Cooking, Firemaking any logs or adding to a bonfire, offering bones at a prayer altar, fletching, smelting, crafting, farming, magic",
          effects: [
  ...
  mechanicChanges: [
    ...
    "Some shops have expanded their wares:",
